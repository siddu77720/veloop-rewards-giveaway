// src/components/GiveawaysSection/GiveawaysSection.jsx
import { useState } from 'react';
import { Link } from 'react-router-dom';
import { FaSearch, FaFire, FaClock, FaCoins, FaUsers, FaArrowRight } from 'react-icons/fa';
  ...
  return (
    <section className={styles.section}>
      ...
      {!loading && filteredPrizes.length > 0 ? (
        ...
        !loading && <EmptyState title="No Giveaways Found" description="Try searching with a different keyword or filter." />
      )}
    </section>
  );
};
